module wealthy/otel/demo

go 1.22.0

require (
	github.com/gin-gonic/gin v1.9.1
	github.com/wealthy/go-kit/web v0.0.0-20240405183759-a360b0a36ab4
)
...
require (
	...
	github.com/wealthy/go-kit/monitoring v0.0.0-20240405183516-3a86049ab31f // indirect
